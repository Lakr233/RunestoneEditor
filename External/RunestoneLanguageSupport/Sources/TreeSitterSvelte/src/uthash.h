...
static int hashmap_create(za_Allocator* A, const unsigned initial_size,
...
static int hashmap_put(struct hashmap_s *const hashmap, const char *const key,
                       const unsigned len, const TagType value) HASHMAP_USED;
...
static TagType hashmap_get(const struct hashmap_s *const hashmap,
...
static int hashmap_iterate(const struct hashmap_s *const hashmap,
                           int (*f)(void *const context, const TagType value),
...
int hashmap_put(struct hashmap_s *const m, const char *const key,
                const unsigned len, const TagType value) {
  unsigned int index;
...
int hashmap_iterate(const struct hashmap_s *const m,
                    int (*f)(void *const, TagType const), void *const context) {
  unsigned int i;
...
int hashmap_rehash_helper(struct hashmap_s *const m) {
  ...
  int flag = hashmap_create(m->A, new_size, &new_hash);
...
// init tags-hashmap
const struct hashmap_s *get_tag_map(za_Allocator *AA) {
